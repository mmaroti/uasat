...
public class SDMeetCond {
	...
	static final Algebra<Boolean> BIG_DADDY = Algebra.wrap(Operation.parse(6, 3,
	...
	static final Algebra<Boolean> LITTLE_SIS = Algebra.wrap(Operation.parse(6, 3,
	...
	public static void main(String[] args) {
		XmlWriter.writeAlgebra(BIG_DADDY, "big-daddy", "p", "q");

		XmlWriter.writeAlgebra(LITTLE_SIS, "little-sis", "p", "q");
	}
}
